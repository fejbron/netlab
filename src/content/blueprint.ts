...
export const EXAM_TOPICS: Record<string, string> = {
  ...
  '5.4': 'Describe security password policy elements, such as management, complexity, and password alternatives',
...
export const PATH_OVERVIEW = {
  ...
  outcomes: [
    ...
    'Defend the access layer with DHCP snooping, dynamic ARP inspection and port security, and enforce password policy and AAA.',
    'Enable RESTCONF and NETCONF, read and change a device as JSON, feed telemetry to an operations platform, and verify an AI-proposed change before trusting it.',
