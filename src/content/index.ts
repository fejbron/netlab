...
export const modules: Module[] = [
  ...
  { id: 'learn-stp', order: 4, title: 'Learn Spanning Tree', description: 'Read the tree, place the root bridge, protect edge ports, and recover a BPDU-guarded uplink.' },
  { id: 'secure-the-switch', order: 5, title: 'Secure the Switch', description: 'Encrypt passwords, enable SSH, lock down unused ports, and secure user ports.' },
  { id: 'learn-routing', order: 6, title: 'Learn Routing', description: 'Address router interfaces, build routing tables with static routes, and connect networks.' },
  { id: 'learn-ospf', order: 7, title: 'Learn OSPF', description: 'Let routers discover each other and exchange routes with single-area and multi-area OSPF.' },
  { id: 'learn-acls', order: 8, title: 'Learn ACLs', description: 'Filter traffic with standard and extended access lists and protect management access.' },
  { id: 'learn-dhcp', order: 9, title: 'Learn DHCP', description: 'Hand out addresses from a router, relay across the network, and troubleshoot leases.' },
  { id: 'learn-nat', order: 10, title: 'Learn NAT', description: 'Publish a server with static NAT and share one public address with PAT.' },
  { id: 'learn-ipv6', order: 11, title: 'Learn IPv6', description: 'Address interfaces with global and link-local IPv6, then route between IPv6 networks.' },
  { id: 'ccna-exams', order: 12, title: 'CCNA Exams', description: 'Multi-device capstone exams that combine switching, routing, OSPF, ACLs, DHCP, NAT, IPv6, troubleshooting and hardening.' },
];
