...
src/
  engine/              Pure TypeScript, no React. Fully unit-tested.
    ...
    linux/commands.ts  Linux utilities (files, text, users, systemd, apt, networking, python3 hand-off)
