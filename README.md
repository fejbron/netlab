...
src/
  engine/              Pure TypeScript, no React. Fully unit-tested.
    ...
    linux/web.ts       nginx configuration parser and validator, HTTP serving, proxying, upstreams, certificates
...
- [ ] nginx access and error logs written as requests are served, rate limiting, gzip and caching
